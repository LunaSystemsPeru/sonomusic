...
public class Print_Venta_Ticket {
    ...
    public void generar_ticket() {
        ...
        printer.printTextLinCol(8, 1, varios_impresion.centrar_texto(40, c_sunat.getDescripcion() + " ELECTRONICA"));
        ...
        printer.printTextLinCol(13, 1, c_cliente.getDireccion());
        ...
        try {
            ...
            while (rs.next()) {
                ...
                printer.printTextWrap(14 + add_filas, 15 + add_filas + 1, 0, 40, texto_linea);
                add_filas++;
                ...
                printer.printTextLinCol(14 + add_filas, 29, " x " + varios_impresion.texto_derecha(9, sparcial));
            }
        ...
        add_filas++;
        add_filas++;
        printer.printTextLinCol(14 + add_filas, 1, varios_impresion.texto_derecha(30, "SUB TOTAL"));
        printer.printTextLinCol(14 + add_filas, 31, varios_impresion.texto_derecha(10, c_varios.formato_totales(subtotal)));
        
        add_filas++;
        printer.printTextLinCol(14 + add_filas, 1, varios_impresion.texto_derecha(30, "IGV"));
        printer.printTextLinCol(14 + add_filas, 31, varios_impresion.texto_derecha(10, c_varios.formato_totales(igv)));
        
        add_filas++;
        printer.printTextLinCol(14 + add_filas, 1, varios_impresion.texto_derecha(30, "TOTAL"));
        printer.printTextLinCol(14 + add_filas, 31, varios_impresion.texto_derecha(10, c_varios.formato_totales(total)));
        
        add_filas++;
        printer.printTextWrap(14 + add_filas, 14 + add_filas + 1, 0, 40, numeros_texto);
