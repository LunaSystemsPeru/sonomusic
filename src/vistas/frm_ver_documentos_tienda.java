 ...
 * @author luis
 */
public class frm_ver_documentos_tienda extends javax.swing.JInternalFrame {

    /**
     * Creates new form frm_documentos_tienda
     */
    ...
    private void initComponents() {
        ...
        setTitle("Ver Documentos de Tienda");

        t_empresas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"1", "BOLETA  | BL", "B001", "00000214"},
                {"2", "FACTURA | FT", "F001", "00000012"},
                {null, null, null, null},
                {null, null, null, null}
            },
            new String [] {
                "ID.", "Nombre", "Serie", "Numero"
            }
        ));
        ...
        if (t_empresas.getColumnModel().getColumnCount() > 0) {
            t_empresas.getColumnModel().getColumn(0).setPreferredWidth(30);
            t_empresas.getColumnModel().getColumn(1).setPreferredWidth(150);
            t_empresas.getColumnModel().getColumn(2).setPreferredWidth(60);
            t_empresas.getColumnModel().getColumn(3).setPreferredWidth(60);
        }
